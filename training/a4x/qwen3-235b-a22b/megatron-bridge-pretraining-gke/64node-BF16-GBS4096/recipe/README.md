...
export RECIPE_ROOT=$REPO_ROOT/training/a4x/qwen3-235b-a22b/megatron-bridge-pretraining-gke/64node-BF16-GBS4096/recipe
cd $RECIPE_ROOT
```
...
```bash
cd $RECIPE_ROOT
export WORKLOAD_NAME=$USER-qwen3-235b-64node-bf16-gbs4096
...
For example: `$USER-qwen3-235b-64node-bf16-gbs4096-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-qwen3-235b-64node-bf16-gbs4096
```