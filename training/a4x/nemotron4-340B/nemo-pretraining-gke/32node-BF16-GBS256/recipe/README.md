<!-- mdformat global-off -->
# Pretrain nemotron4-340b workloads on a4x GKE Node pools with Nvidia NeMo Framework

This recipe outlines the steps for running a nemotron4-340b pretraining
...
export RECIPE_ROOT=$REPO_ROOT/training/a4x/nemotron4-340B/nemo-pretraining-gke/32node-BF16-GBS256/recipe
cd $RECIPE_ROOT
```
...
--set-file workload_config=nemotron4-340b-bf16-gbs256-gpus128.py \
...
```
kubectl get pods | grep $USER-a4x-nemotron4-340b-32node
```

Replace the following:

- JOB_NAME_PREFIX - your job name prefix. For example $USER-a4x-nemotron4-340b-32node.
...
For example: `$USER-a4x-nemotron4-340b-32node-workload-0-0-s9zrv`.
...
```bash
helm uninstall $USER-a4x-nemotron4-340b-32node
```
